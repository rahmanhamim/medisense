const services = [
 {
  ...
  img: "https://i.ibb.co/k8J0xLp/service1.jpg",
  descrption:
  ...
  cost: "$3000 - $5000",
  otherDetails:
   "1. Dental implants are virtually as strong as the natural teeth they replace. 2. Dental implant surgery is not complicated or dangerous. 3. It is quite easy to take care of dental implantsDental implants guard against bone loss. 4. Dental implants provide health benefits.",
 },
 {
  id: 2,
  name: "Blood Bank",
  img: "https://i.ibb.co/vwscQxh/service2.jpg",
  descrption:
  ...
  cost: "$200 - $300",
  otherDetails:
   "1. Whole blood donors earn 100 points. 2. Apheresis donors earn 150 points. 3. Double Red Donors earn 300 points. 4. In addition, every third donation in a calendar year receives 100 bonus points.",
 },
 {
  id: 3,
  name: "Medicine Research",
  img: "https://i.ibb.co/YWyHvvT/service3.jpg",
  descrption:
   "Medical research, also known as experimental medicine, encompasses a wide array of research, extending from 'basic research', – involving fundamental scientific principles that may apply to a preclinical understanding – to clinical research, which involves studies of people who may be subjects in clinical trials.",
  cost: "$900 million to $1.3 billion",
  otherDetails:
 ...
 },
 {
  ...
  img: "https://i.ibb.co/K9hDDpP/service4.jpg",
  descrption:
   "A visit by a Care Services Pharmacist to support and advise homes: • A structured visit focusing on supporting and advising the home with. medicines management. • Responding to the needs of those working and living in the home..",
  cost: "$1000 to $1200",
  otherDetails:
 ...
 },
 {
  ...
  img: "https://i.ibb.co/c6KM8GL/service5.jpg",
  descrption:
  ...
  cost: "$400 to $700",
  otherDetails:
   "In general, patient counseling has 3 main objectives: assessing the patient understanding of the therapy. In addition to including proper use and adverse effects of the medication; improving patient adherence; and motivating the patient to take an active role in health management..",
 },
 {
  id: 6,
  name: "Lab Tests",
  img: "https://i.ibb.co/TB1xFc8/service6.jpg",
  descrption:
